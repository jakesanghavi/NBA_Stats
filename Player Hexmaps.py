...
# player_names = pd.read_csv("player_id_matches_2020_2.csv")
player_names = pd.read_csv('stats_nba_player_data_2020-21.csv')

# Old
player_name = input("Input player name: ")
player_id = player_names.loc[player_names['PLAYER_NAME']==player_name]
player_id = str(player_id['PLAYER_ID'].iloc[0])
...
plt.hexbin(shots_x, shots_y, C=shots_z, cmap='coolwarm', gridsize=15)
...
# Add a title
ax.set_title(player_name + ' Hot Zones \n' + player_season + ' Regular Season',
            y=1.0, fontsize=18, loc='left')

# plt.title(player_name + ' Shot Density Chart \n' + player_season + ' Regular Season',
#              y=1.2, fontsize=18, loc='left')
